...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/raspy-mountain-5c38)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/raspy-mountain-5c38
```

A live public deployment of this template is available at [https://raspy-mountain-5c38.templates.workers.dev](https://raspy-mountain-5c38.templates.workers.dev)
